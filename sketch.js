...
function setup(){
    ...
    //creating bhoviya and adding image to her and setting the cpllider
    ...
    winnerText = createSprite((displayWidth - 50)/2, (displayHeight - 200)/4);
...
function draw(){
    ...
    if(gameState === PLAY){
      ...
      if(mousePressedOver(jButton) && bhoviya.collide(vGround)) {
        jumpSound.play();
